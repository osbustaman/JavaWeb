...
--
-- Volcado de datos para la tabla `gp_cargo`
--

INSERT INTO `gp_cargo` (`id`, `nombre_cargo`) VALUES
(1, 'Programador'),
(2, 'Jefe de proyectos');
...
CREATE TABLE `gp_colaborador` (
  ...
  `path_colaborador` text DEFAULT NULL,
  `image_colaborador` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Volcado de datos para la tabla `gp_expediente_colaborador`
--
